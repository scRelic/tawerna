...
import icon from "@/assets/icons/products-icon.svg";
...
const buyItem = () => {
  userStore.buyItem(targetItem.value);
...
<template>
  <MainLayout class="relative">
    <div class="wrapper-mainLayout">
      <TitleComponent :title="'Items'" :icon="icon" />
      <CardListComponent @update:open-modal="openModal" />
          ...
          <div class="modal-content">
            ...
            <div class="w-full">
              <ul class="list">
                ...
                <li class="list-item">Тип: <span class="list-item-value">Sword</span></li>
